...
class RapportVenteProduitByUserType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        'widget' => 'single_text',
        'required' => false))
        ->add('user',EntityType::class, array('class' => 'userManagerBundle:User',
                    'placeholder'=>'Veuillez choisir l agent'))
        ->add('produit',EntityType::class, array('class' => 'ProduitBundle:Produit',
