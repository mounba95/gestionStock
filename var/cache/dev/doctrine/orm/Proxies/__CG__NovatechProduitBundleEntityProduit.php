 ...
 */
class Produit extends \Novatech\ProduitBundle\Entity\Produit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Novatech\\ProduitBundle\\Entity\\Produit' . "\0" . 'id', '' . "\0" . 'Novatech\\ProduitBundle\\Entity\\Produit' . "\0" . 'nomProduit', '' . "\0" . 'Novatech\\ProduitBundle\\Entity\\Produit' . "\0" . 'referenceProduit', '' . "\0" . 'Novatech\\ProduitBundle\\Entity\\Produit' . "\0" . 'descriptionProduit', '' . "\0" . 'Novatech\\ProduitBundle\\Entity\\Produit' . "\0" . 'typeProduit', '' . "\0" . 'Novatech\\ProduitBundle\\Entity\\Produit' . "\0" . 'stock'];
        }
