...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.user.provider.concrete.in_database' => 'getSecurity_User_Provider_Concrete_InDatabaseService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('doLV2-D9dy', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hNzgFtK9Su', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hHJiLbXDnx', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('belGFqKj-q', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hXAlDIywc4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\ProduitBundle/Resources/views'), 'Produit');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\ProduitBundle/Resources/views'), '!Produit');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\StockBundle/Resources/views'), 'Stock');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\StockBundle/Resources/views'), '!Stock');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\ClientBundle/Resources/views'), 'Client');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\ClientBundle/Resources/views'), '!Client');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\InformationBundle/Resources/views'), 'Information');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\InformationBundle/Resources/views'), '!Information');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\FournisseurBundle/Resources/views'), 'Fournisseur');
        $instance->addPath(($this->targetDirs[3].'\\src\\Novatech\\FournisseurBundle/Resources/views'), '!Fournisseur');
        $instance->addPath(($this->targetDirs[3].'\\src\\userManagerBundle/Resources/views'), 'userManager');
        $instance->addPath(($this->targetDirs[3].'\\src\\userManagerBundle/Resources/views'), '!userManager');
        $instance->addPath(($this->targetDirs[3].'\\src\\Banque\\CompteBundle/Resources/views'), 'Compte');
        $instance->addPath(($this->targetDirs[3].'\\src\\Banque\\CompteBundle/Resources/views'), '!Compte');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'ProduitBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Novatech\\ProduitBundle'),
                    'namespace' => 'Novatech\\ProduitBundle',
                ],
                'StockBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Novatech\\StockBundle'),
                    'namespace' => 'Novatech\\StockBundle',
                ],
                'ClientBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Novatech\\ClientBundle'),
                    'namespace' => 'Novatech\\ClientBundle',
                ],
                'InformationBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Novatech\\InformationBundle'),
                    'namespace' => 'Novatech\\InformationBundle',
                ],
                'FournisseurBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Novatech\\FournisseurBundle'),
                    'namespace' => 'Novatech\\FournisseurBundle',
                ],
                'userManagerBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\userManagerBundle'),
                    'namespace' => 'userManagerBundle',
                ],
                'CompteBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\Banque\\CompteBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ProduitBundle' => 'Novatech\\ProduitBundle\\ProduitBundle',
                'StockBundle' => 'Novatech\\StockBundle\\StockBundle',
                'ClientBundle' => 'Novatech\\ClientBundle\\ClientBundle',
                'InformationBundle' => 'Novatech\\InformationBundle\\InformationBundle',
                'FournisseurBundle' => 'Novatech\\FournisseurBundle\\FournisseurBundle',
                'userManagerBundle' => 'userManagerBundle\\userManagerBundle',
                'CompteBundle' => 'Banque\\CompteBundle\\CompteBundle',
