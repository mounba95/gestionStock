...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\Novatech\\ProduitBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Novatech\\StockBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Novatech\\ClientBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Novatech\\InformationBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Banque\\CompteBundle\\Entity')]);
$d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver([($this->targetDirs[3].'\\src\\userManagerBundle\\Resources\\config\\doctrine') => 'userManagerBundle\\Entity']);
$d->setGlobalBasename('mapping');

$b->addDriver($c, 'Novatech\\ProduitBundle\\Entity');
$b->addDriver($c, 'Novatech\\StockBundle\\Entity');
$b->addDriver($c, 'Novatech\\ClientBundle\\Entity');
$b->addDriver($c, 'Novatech\\InformationBundle\\Entity');
$b->addDriver($c, 'Banque\\CompteBundle\\Entity');
$b->addDriver($d, 'userManagerBundle\\Entity');

$a->setEntityNamespaces(['ProduitBundle' => 'Novatech\\ProduitBundle\\Entity', 'StockBundle' => 'Novatech\\StockBundle\\Entity', 'ClientBundle' => 'Novatech\\ClientBundle\\Entity', 'InformationBundle' => 'Novatech\\InformationBundle\\Entity', 'userManagerBundle' => 'userManagerBundle\\Entity', 'CompteBundle' => 'Banque\\CompteBundle\\Entity']);
